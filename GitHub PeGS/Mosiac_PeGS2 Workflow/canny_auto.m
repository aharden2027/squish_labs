...
%       .visualizeParticles : (bool) Whether to generate per-image visualizations
%       .globalMap          : (bool) Whether to generate a global map of matched particles
%
%   verbose (optional) - (bool) If true, prints detailed progress and debug output
%
% OUTPUTS:
...
function canny_auto(fileParams, caParams, verbose)
    ...
    % First image (R0,C0)
    img1 = imread('testdata/images/piece_3_2.png');
    red1 = img1(:,:,1);
    green1 = img1(:,:,2);
