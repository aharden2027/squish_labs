...
runParticleDetect = true; % Run Particle Detect?
runCannyAuto =  false; % Run Canny Auto?
runParticleID = false; % Run Preserve Particle ID?
runContactDetect = false; % Run Contact Detect?
...
if runCannyAuto
    fprintf("\n")
    canny_auto(fileParams, caParams, false);
    fprintf('Canny Auto finished\n');
end

if runParticleID
    fprintf("\n")
    preserveParticleID(fileParams,false);
